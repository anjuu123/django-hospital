...
from .views import Add_Appointment, Add_Patient, Delete_Appointment, Delete_Patient, Index,Logout, Service, Login,Dashboard, View_Appointment, View_Doctor,Delete_Doctor,Add_Doctor, View_Patient
